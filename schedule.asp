...
<html>
  ...
  <body>
    ...
    <%
      ...
      query="select adate,appointment.start_time,pname from patient,doctor,appointment where patient.pno=appointment.pno and doctor.dno=appointment.dno and doctor.dno=" & accountId & " order by adate"
